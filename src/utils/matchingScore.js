...
const INCOMPATIBLE_INDUSTRIES = {
  // 농업/식품 분야
  agriculture: [
    '농업', '농생명', '수산', '축산', '임업', '농촌', '어업', '영농',
    '농식품', '음료', '수산물', '농산물', '축산물', '식품가공', '푸드테크',
  ],
  // 전통 제조업 (IT/SW 기반이 아닌)
  manufacturing: [
    '제조업', '철강', '화학', '섬유', '기계', '금속', '자동차부품',
    '자동차제조', '부품제조', '소재', '원자재',
  ],
  // 전통 상권/유통
  traditional: [
    '전통시장', '골목상권', '도소매', '유통', '재래시장', '전통주',
    '소매업', '소상공인',
  ],
  // 건설/부동산
  ...
  // 에너지/발전 분야 (신규)
  energy: [
    '에너지', '전력', '발전', '신재생', '신재생에너지',
    '태양광', '풍력', 'e-spark', '이스파크', '전기', '가스',
  ],
  // 스마트팜/스마트홈 (하드웨어 중심, 신규)
  smarthome: ['스마트홈', '스마트팜', '스마트농업'],
  // 중공업/조선 (신규)
  heavy_industry: ['중공업', '조선', '선박', '해양플랜트'],
}
...
const TECH_INTERESTS = [
  'AI', 'ICT', 'IT', 'CT', '콘텐츠', '음악', '게임', 'SW', '데이터', '클라우드', '핀테크', '블록체인',
  '바이오', 'IoT', 'VR', 'AR', 'XR', '메타버스', '로봇', '자율주행', '드론',
]
